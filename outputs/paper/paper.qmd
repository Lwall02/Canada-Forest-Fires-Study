...
author: "Liam Wall"
thanks: "Code and data are available at: [https://github.com/Lwall02/Canada-Forest-Fires-Study.git](https://github.com/Lwall02/Canada-Forest-Fires-Study.git)."
date: today
date-format: long
...
first_model <- readRDS(here::here("outputs/models/first_model.rds"))
second_model <- readRDS(here::here("outputs/models/second_model.rds"))
